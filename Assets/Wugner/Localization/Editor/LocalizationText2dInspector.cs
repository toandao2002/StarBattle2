...
{
	[CustomEditor(typeof(LocalizationText2d))]
	public class LocalizationText2dInspector : BaseLocalizationUIInspector
	{
		protected override void UpdateUI(EditorMultiLanguageEntry entryInMultiLanguage, string language)
		{
			try
			{
				...
				var text = ((LocalizationText2d)target).GetComponent<TextMeshPro>();
